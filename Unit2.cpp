...
void DrawMassWithUndangerPlanersAndImage(int **MassFirst, int SizeOfMass, int SizeOfSquare,TBitmap *Bitmap,TColor FonColor,TBitmap *Squar, TBitmap *Planer)
{
	...
	for (i = 0; i < SizeOfMass; i++)
	{
		for (j = 0; j < SizeOfMass; j++)
		{
			...
			if (MassFirst[i][j]== 1)
			{
				DrawImage(i*SizeOfSquare+10,j*SizeOfSquare+10,SizeOfSquare,Bitmap,Squar);
			}
		}
	}
		...
		for (j = 0; j < SizeOfMass; j++)
		{
			...
			if (EcranInfo(MassFirst,MassEcranX,MassEcranY)==true)
			{
				...
				&& (MassFirst[XMass[8]][YMass[8]]==1))
				{
					...
					DrawImage(XMass[1]*SizeOfSquare+10,YMass[1]*SizeOfSquare+10,SizeOfSquare,Bitmap,Planer);
					DrawImage(XMass[5]*SizeOfSquare+10,YMass[5]*SizeOfSquare+10,SizeOfSquare,Bitmap,Planer);
					DrawImage(XMass[6]*SizeOfSquare+10,YMass[6]*SizeOfSquare+10,SizeOfSquare,Bitmap,Planer);
					DrawImage(XMass[7]*SizeOfSquare+10,YMass[7]*SizeOfSquare+10,SizeOfSquare,Bitmap,Planer);
				...
				&& (MassFirst[XMass[8]][YMass[8]]==0))
				{
					...
					DrawImage(XMass[0]*SizeOfSquare+10,YMass[0]*SizeOfSquare+10,SizeOfSquare,Bitmap,Planer);
					DrawImage(XMass[2]*SizeOfSquare+10,YMass[2]*SizeOfSquare+10,SizeOfSquare,Bitmap,Planer);
					DrawImage(XMass[4]*SizeOfSquare+10,YMass[4]*SizeOfSquare+10,SizeOfSquare,Bitmap,Planer);
					DrawImage(XMass[5]*SizeOfSquare+10,YMass[5]*SizeOfSquare+10,SizeOfSquare,Bitmap,Planer);
					DrawImage(XMass[7]*SizeOfSquare+10,YMass[7]*SizeOfSquare+10,SizeOfSquare,Bitmap,Planer);
				...
				&& (MassFirst[XMass[8]][YMass[8]]==1))
				{
					...
					DrawImage(XMass[2]*SizeOfSquare+10,YMass[2]*SizeOfSquare+10,SizeOfSquare,Bitmap,Planer);
					DrawImage(XMass[3]*SizeOfSquare+10,YMass[3]*SizeOfSquare+10,SizeOfSquare,Bitmap,Planer);
					DrawImage(XMass[5]*SizeOfSquare+10,YMass[5]*SizeOfSquare+10,SizeOfSquare,Bitmap,Planer);
					DrawImage(XMass[7]*SizeOfSquare+10,YMass[7]*SizeOfSquare+10,SizeOfSquare,Bitmap,Planer);
					DrawImage(XMass[8]*SizeOfSquare+10,YMass[8]*SizeOfSquare+10,SizeOfSquare,Bitmap,Planer);
